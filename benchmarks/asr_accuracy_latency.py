...
async def _transcribe(client: httpx.AsyncClient, url: str, model: str, sample: Sample) -> dict:
    ...
    *,
    ...
    def _agg(rs: list[dict]) -> dict:
        ...
        return {
            ...
            "p95_error": (statistics.quantiles(errs, n=20)[18] if len(errs) >= 20 else None),
