...
class SlideViewer {
  ...
  async _handleUpload(file) {
    ...
    // modal-system.bootstrap.js). Fall back to window.alert only when
    // slide-viewer is loaded before the modal-system bootstrap, so we
    // never silently swallow an upload rejection.
