...
@pytest.mark.parametrize(
    "bad_session",
    # 41 chars is over the loosened limit (40 chars accommodates a UUID
    # hex without dashes for per-tab tmux sessions; see TMUX_NAME_RE).
    ["", "has spaces", "semi;colon", "back`tick", "$expand", "../traversal", "a" * 41],
)
