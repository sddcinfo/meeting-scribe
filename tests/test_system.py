...
class TestBackendConsistency:
    ...
    def test_single_canonical_speaker_color_function(self):
        ...
        """
        # `getSpeakerColor` was migrated out of the original scribe-app.js
        # to features/speaker-palette.js (lib/speaker-palette.js) in Phase
        # 3 Tier 1. Update the assertion to look there.
        js = (
            Path(__file__).parent.parent / "static" / "js" / "scribe" / "lib" / "speaker-palette.js"
        ).read_text()
