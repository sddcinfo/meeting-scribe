...
Priority ladder (lower wins):
  ...
  -10  live translate, live TTS, summary (post-meeting)
...
class TestSummaryPriority:
    ...
    vLLM instance. It runs at the same tier as live translation (-10)
    so it preempts the coding agent but never blocks live paths."""
