...
async def _handle_connection(
    ...
    *,
    ...
    if not verb:
        writer.write(encode_response(ok=False, request_id=request_id, error="invalid_request"))
        await writer.drain()
        writer.close()
        return
    ...
    if spec is None:
        ...
        writer.write(encode_response(ok=False, request_id=request_id, error="unknown_verb"))
        await writer.drain()
        writer.close()
        return
    ...
    try:
        ...
        logger.exception(
            "verb_unhandled peer_uid=%d verb=%r request_id=%r", peer_uid, verb, request_id
        )
