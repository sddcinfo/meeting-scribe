...
def reprocess(meeting_ids: tuple[str, ...], vllm_url: str) -> None:
    """Re-process meetings: regenerate AI summaries.

    Re-runs summary generation on completed meetings. Useful after
    model upgrades or when processing was interrupted.
