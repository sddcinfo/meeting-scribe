...
* ``exclusive_segments`` — community-1 single-speaker-per-frame
  ...
  for primary-speaker assignment on each ASR event window.  Community-1
  resolves 100 % of 3.1's overlapping seconds to a single-speaker
  assignment (Track C measurement, 40-min 4-speaker production
  meeting).
