...
class Metrics:
    ...
    def reset(self) -> None:
        ...
        self.tts_dropped_translator_meta: int = 0
        self.tts_dropped_recovery_flush: int = 0
        self.local_tts_echo_suppressed_chunks: int = 0
        # Soft input-mute: count of audio chunks dropped at the input
        # boundary while ``state.mic_input_muted`` was True. Surfaces in
        # /api/status so an operator can prove the privacy pause held.
        self.mic_muted_chunks_dropped: int = 0
    ...
    def to_dict(self) -> dict:
        tts_block = {
            ...
            "drops": {
                ...
                "translator_meta": self.tts_dropped_translator_meta,
                "recovery_flush": self.tts_dropped_recovery_flush,
            },
            "timeouts": self.tts_synth_timeouts,
            "local_echo_suppressed_chunks": self.local_tts_echo_suppressed_chunks,
