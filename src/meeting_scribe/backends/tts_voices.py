...
# Keep this away from English/Japanese: those languages must use their native
# studio speakers so room interpretation does not drift into a generic
# "Asian multilingual" voice.
...
_STUDIO_VOICES: dict[str, str] = {
    # Aiden — "sunny American male, clear midrange". Picked over Ryan
    # ("dynamic male, strong rhythm") on 2026-05-13 after a live audit:
    # Ryan still reads as slightly Asian-accented on short button-
    # feedback strings ("Volume up", "Mic muted"); Aiden is the
    # clearer American voice and is also our pick for Spanish/Italian,
    # so a single speaker covers more of the western-language surface.
    "en": "aiden",
    "zh": "vivian",
    # Ono_Anna is the native Japanese speaker. Do not fall back Japanese to
    # Chinese/Korean/multilingual voices; perceived accent matters here.
    "ja": "ono_anna",
    "ko": "sohee",
    "de": _STUDIO_FALLBACK,
    "fr": _STUDIO_FALLBACK,
